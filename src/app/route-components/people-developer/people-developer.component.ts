...
@Component({
  selector: 'app-people-developer',
  templateUrl: './people-developer.component.html',
  styleUrls: ['./people-developer.component.scss']
})
export class PeopleDeveloperComponent implements OnInit, OnDestroy, AfterViewInit {
