...
@Component({
  selector: 'app-business-operator',
  templateUrl: './business-operator.component.html',
  styleUrls: ['./business-operator.component.scss']
})
export class BusinessOperatorComponent implements OnInit, OnDestroy, AfterViewInit {
